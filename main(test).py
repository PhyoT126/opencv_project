...
addPhoto=CTkButton(image_label,text="Browse Your Image ",font=("Poppins",16),image=uploadPhoto,fg_color="transparent",hover_color="null",compound="top",anchor="end",text_color="#EDEADE",corner_radius=32,command=addImage)
addPhoto.place(x=258,y=166)

download_Button=CTkButton(root,image=downloadPhoto,text="",bg_color="transparent",fg_color="transparent",hover_color="",width=20,command=saveToDirectory)
download_Button.place(x=1260,y=500)

generate_Button=CTkButton(root,text="Generate",font=("Poppins",20),border_width=0,corner_radius=32,fg_color="#00A36C", width = 796, height=40, hover_color="null")
...
home=CTkButton(sideFrame,text="Image-to-Cartoon    ",font=("Poppins",14),hover_color="#00A36C",bg_color="transparent",fg_color="transparent",corner_radius=32,state=NORMAL)
home.place(x=12,y=80)

images=CTkButton(sideFrame,text="Image-to-Text   ",font=("Poppins",14),hover_color="#00A36C",bg_color="transparent",fg_color="transparent",corner_radius=32)
